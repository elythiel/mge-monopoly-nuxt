<template>
  <nav
      class="transition-all duration-500 bg-darkblue fixed top-0 z-30 w-full flex flex-row justify-end items-center uppercase px-2 lg:px-12 text-sm lg:text-xl 2xl:px-16 2xl:text-2xl"
      :class="isDark ? 'md:pt-2 2xl:pt-9 bg-mge-darkblue text-white' : 'shadow-md bg-white pt-0 text-mge-darkblue'"
  >
    <div ref="underline"
         class="nav-underline h-0.5 absolute opacity-0 self-end"
         :class="isDark ? 'bg-white' : 'bg-mge-darkblue'"
    ></div>
